    ...
    providers: [
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$auth$2f$providers$2f$credentials$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])({
            ...
            async authorize (credentials) {
                const res = await fetch(`${("TURBOPACK compile-time value", "http://localhost:10000")}/api/auth/login`, {
                    method: "POST",
                    headers: {
    ...
    callbacks: {
        async jwt ({ token, user }) {
            if (user) {
                ...
                // 🔥 backend JWT
                token.backendToken = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].sign({
                    id: user.id,
                    email: user.email,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__969da9e2._.js.map